...
jqueryWidget: {
    _init: function () {
        ...
        this.continueMessage = dget(this.options, "continueMessage", "Next question");
        ...
        if (this.continueMessage) {
            this.element.append($("<button>").append($("<p>").append($("<a>").attr('href', '').text(this.continueMessage)
                                                .addClass(ibex_controller_name_to_css_prefix("Message") + "personalMessage")))
                                                .click(handler));
        }
